                ...
                <div className="row g-4 justify-content-center">
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div className="service-item bg-white text-center h-100 p-4 p-xl-5">
                            <img className="img-fluid mb-4" src="https://res.cloudinary.com/dwx2jd8b1/image/upload/v1698518249/Website-assets/blueDefender/icon-1_y9xama.png" alt="" />
                    ...
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div className="service-item bg-white text-center h-100 p-4 p-xl-5">
                            <img className="img-fluid mb-4" src="https://res.cloudinary.com/dwx2jd8b1/image/upload/v1698518254/Website-assets/blueDefender/icon-2_vnlv6f.png" alt="" />
                    ...
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div className="service-item bg-white text-center h-100 p-4 p-xl-5">
                            <img className="img-fluid mb-4" src="https://res.cloudinary.com/dwx2jd8b1/image/upload/v1698518254/Website-assets/blueDefender/icon-3_ucufvc.png" alt="" />
